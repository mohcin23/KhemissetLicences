...
const LICENCE_CONFIGS = {
  ...
  pharmacie: {
    ...
    documents: [
      { key: 'cin_proprietaire', label_fr: 'CIN du propriétaire', label_ar: 'بطاقة التعريف الوطنية للمالك', ocr: true, ocr_fields: ['nom', 'prenom', 'cin', 'date_naissance', 'adresse', 'commune', 'cercle', 'nom_ar', 'prenom_ar', 'adresse_ar', 'commune_ar', 'cercle_ar'] },
      { key: 'diplome_pharmacie', label_fr: 'Diplôme de pharmacie', label_ar: 'دبلوم الصيدلة', ocr: true, ocr_fields: ['nom', 'specialite', 'universite', 'annee'] },
      { key: 'permis_exercice', label_fr: "Permis d'exercice", label_ar: 'رخصة المزاولة', ocr: true, ocr_fields: ['numero_permis', 'date_permis'] },
  ...
  cafe_restaurant: {
    ...
    documents: [
      { key: 'cin_proprietaire', label_fr: 'CIN du propriétaire', label_ar: 'بطاقة التعريف الوطنية للمالك', ocr: true, ocr_fields: ['nom', 'prenom', 'cin', 'date_naissance', 'adresse', 'commune', 'cercle', 'nom_ar', 'prenom_ar', 'adresse_ar', 'commune_ar', 'cercle_ar'] },
      { key: 'bail_propriete', label_fr: 'Bail ou titre de propriété', label_ar: 'عقد الكراء أو سند الملكية', ocr: true, ocr_fields: ['adresse_local', 'superficie', 'nom_proprietaire'] },
    ...
    form_sections: [
      ...
      { key: 'type_etablissement', label_fr: "Type d'établissement", label_ar: 'نوع المؤسسة', type: 'select', required: true, section: 'etablissement', options: ['Café', 'Restaurant', 'Café-Restaurant', 'Fast-food', 'Snack'] },
  ...
  hopital_clinique: {
    ...
    documents: [
      { key: 'cin_directeur', label_fr: 'CIN du directeur médical', label_ar: 'بطاقة التعريف الوطنية للمدير الطبي', ocr: true, ocr_fields: ['nom', 'prenom', 'cin', 'date_naissance', 'adresse', 'commune', 'cercle', 'nom_ar', 'prenom_ar', 'adresse_ar', 'commune_ar', 'cercle_ar'] },
      { key: 'diplome_medecin', label_fr: 'Diplôme de médecine / spécialité', label_ar: 'دبلوم الطب / التخصص', ocr: true, ocr_fields: ['nom', 'specialite', 'universite', 'annee'] },
      { key: 'autorisation_exploitation', label_fr: "Autorisation d'exploitation", label_ar: 'رخصة الاستغلال', ocr: true, ocr_fields: ['numero_autorisation', 'date_autorisation'] },
    ...
    form_sections: [
      ...
      { key: 'type_clinique', label_fr: 'Type de clinique', label_ar: 'نوع العيادة', type: 'select', required: true, section: 'etablissement', options: ['Clinique générale', 'Clinique spécialisée', 'Hôpital privé', 'Centre de soins', 'Polyclinique'] },
  ...
  ecole_privee: {
    ...
    documents: [
      { key: 'cin_directeur', label_fr: 'CIN du directeur', label_ar: 'بطاقة التعريف الوطنية للمدير', ocr: true, ocr_fields: ['nom', 'prenom', 'cin', 'date_naissance', 'adresse', 'commune', 'cercle', 'nom_ar', 'prenom_ar', 'adresse_ar', 'commune_ar', 'cercle_ar'] },
      { key: 'diplome_directeur', label_fr: 'Diplôme du directeur', label_ar: 'دبلوم المدير', ocr: true, ocr_fields: ['nom', 'specialite', 'universite', 'annee'] },
    ...
    form_sections: [
      ...
      { key: 'cycle', label_fr: "Cycle d'enseignement", label_ar: 'مستوى التعليم', type: 'select', required: true, section: 'etablissement', options: ['Préscolaire', 'Primaire', 'Collège', 'Lycée', 'Préscolaire + Primaire', 'Tous cycles'] },
  ...
  salle_sport: {
    ...
    documents: [
      { key: 'cin_proprietaire', label_fr: 'CIN du propriétaire', label_ar: 'بطاقة التعريف الوطنية للمالك', ocr: true, ocr_fields: ['nom', 'prenom', 'cin', 'date_naissance', 'adresse', 'commune', 'cercle', 'nom_ar', 'prenom_ar', 'adresse_ar', 'commune_ar', 'cercle_ar'] },
      { key: 'bail_propriete', label_fr: 'Bail ou titre de propriété', label_ar: 'عقد الكراء أو سند الملكية', ocr: false },
      { key: 'diplome_education_physique', label_fr: "Diplôme d'éducation physique", label_ar: 'دبلوم التربية البدنية', ocr: true, ocr_fields: ['nom', 'specialite', 'universite', 'annee', 'nom_ar', 'specialite_ar', 'universite_ar'] },
    ...
    form_sections: [
      ...
      { key: 'adresse', label_fr: 'Adresse', label_ar: 'العنوان', type: 'textarea', required: true, section: 'etablissement' },
      { key: 'superficie', label_fr: 'Superficie (m²)', label_ar: 'المساحة (م²)', type: 'number', required: true, section: 'etablissement' },
      { key: 'type_activites', label_fr: "Type d'activités", label_ar: 'نوع الأنشطة', type: 'select', required: true, section: 'etablissement', options: ['Musculation', 'Arts martiaux', 'Fitness / Cardio', 'Natation', 'Sports collectifs', 'Multi-activités'] },
