    ...
    documents: [
      {
        ...
        ocr_prompt: `Extrais les informations suivantes de cette CIN marocaine et retourne UNIQUEMENT un JSON valide sans commentaires ni markdown (la CIN contient du texte en français ET en arabe) :

⚠ IMPORTANT: Pour les champs arabes, extrais UNIQUEMENT la valeur sans le label/préfixe. Ex: si le document montre "الدائرة : الخميسات", retourne "الخميسات" et non "الدائرة : الخميسات".

{
  "nom": "nom de famille en français",
  "prenom": "prénom en français",
  "nom_ar": "الاسم العائلي بالعربية (valeur uniquement, sans préfixe)",
  "prenom_ar": "الاسم الشخصي بالعربية (valeur uniquement, sans préfixe)",
  ...
  "adresse_ar": "العنوان بالعربية (valeur uniquement, sans préfixe comme 'العنوان : ')",
  "commune": "commune en français",
  "commune_ar": "الجماعة بالعربية (valeur uniquement, sans préfixe comme 'الجماعة : ')",
  "cercle": "cercle en français",
  "cercle_ar": "الدائرة بالعربية (valeur uniquement, sans préfixe comme 'الدائرة : ')"
}
        ...
        ocr_prompt: `Extrais les informations suivantes de cette CIN marocaine et retourne UNIQUEMENT un JSON valide sans commentaires ni markdown (la CIN contient du texte en français ET en arabe) :
{
  "nom": "nom de famille en français",
  "prenom": "prénom en français",
  "nom_ar": "الاسم العائلي بالعربية كما يظهر على البطاقة",
  "prenom_ar": "الاسم الشخصي بالعربية كما يظهر على البطاقة",
  "cin": "numéro CIN (lettres majuscules + chiffres)",
  "date_naissance": "date de naissance au format YYYY-MM-DD",
  "adresse": "adresse complète inscrite sur la CIN",
  "adresse_ar": "العنوان بالعربية كما يظهر على البطاقة",
  "commune": "commune en français",
  "commune_ar": "الجماعة بالعربية كما يظهر على البطاقة",
  "cercle": "cercle en français",
  "cercle_ar": "الدائرة بالعربية كما يظهر على البطاقة"
}
Champ non trouvé = chaîne vide "".`
      },
      {
...
Champ non trouvé = chaîne vide "".`
      ...
      },
      {
        ...
        ocr_prompt: `Extrais les informations suivantes de ce diplôme d'éducation physique ou sportive et retourne UNIQUEMENT un JSON valide sans commentaires ni markdown (le document contient du texte en français ET en arabe) :

⚠ IMPORTANT: Pour les champs arabes, extrais UNIQUEMENT la valeur sans le label/préfixe.

{
  "nom": "nom complet du titulaire",
  "nom_ar": "الاسم الكامل بالعربية (valeur uniquement, sans préfixe)",
  "specialite": "spécialité ou qualification sportive",
  "specialite_ar": "التخصص بالعربية (valeur uniquement, sans préfixe)",
  "universite": "nom de l'établissement ou institut",
  "universite_ar": "الجامعة بالعربية (valeur uniquement, sans préfixe)",
  "annee": "année d'obtention (YYYY)"
}
Champ non trouvé = chaîne vide "".`
      },
